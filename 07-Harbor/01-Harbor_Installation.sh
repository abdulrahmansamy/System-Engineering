...
echo
echo -e "$Yellow[Stage 01]: Download and Extract the Harbor Packages$NOCOLOR"
echo -e "$Yellow===================================================$NOCOLOR"


echo
echo -e "$Light_Yellow[Stage 01.1]: Download Harbor Online Packages$NOCOLOR"
...
echo
echo -e "$Light_Yellow[Stage 01.2]: Verify the package is genuine$NOCOLOR"
echo -e "$Light_Yellow------------------------------------------$NOCOLOR"
...
echo
echo -e "$Light_Yellow[Stage 01.3]: Extracting the Package$NOCOLOR"
echo -e "$Light_Yellow-----------------------------------$NOCOLOR"
