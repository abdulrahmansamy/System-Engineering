...
#
# Version: 4.0.1 - Enterprise Production Features: Failover Testing, Witness Node, GCS Backups, Monitoring, MOTD
...
set_timezone() {
  ...
  if [[ -n "$metadata_tz" && -f "/usr/share/zoneinfo/$metadata_tz" ]]; then
    ...
    case "$gce_zone" in
      *me-central2*|*middle-east*) tz="Asia/Riyadh" ;;  # Middle East zones
