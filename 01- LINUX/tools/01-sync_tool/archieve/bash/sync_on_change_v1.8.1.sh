...
# -----------------------------------------------------------------------------
# Script: sync_on_change_v1.8.0.sh
# Version: 1.8.0
#
# Purpose:
...
universal_path_installer() {
  ...
  local SCRIPT_NAME
  #   SCRIPT_NAME="$(basename "$SCRIPT_PATH")"  # keep original name for display, 
  SCRIPT_NAME="sync_on_change"  # Fixed name for installed binary to skip version suffixes
...
set_defaults
parse_args "$@"          # NOTE: --install/--update/--uninstall/--gen-config exit inside parse_args
